...
export var wallSound = new soundFile("wallboing.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("quack.mp3");
soundArray.push(paddleSound);

export var scoreSound = new soundFile("miss.mp3");
soundArray.push(scoreSound);

export var ambientSound = new soundFile("silly.mp3");
